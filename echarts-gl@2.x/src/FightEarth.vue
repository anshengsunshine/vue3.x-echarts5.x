...
use([GlobeComponent, Lines3DChart, Scatter3DChart]);
import VChart from "vue-echarts";

export default {
  name: "echartsGLEarth3D",
  components: {
    VChart,
  },
  setup() {
      ...
      fetch("http://www.youbaobao.xyz/datav-res/datav/flights.json")
        ...
        .then((data) => {
          ...
          options.value = {
            ...
            globe: {
              environment: require("@/assets/star-bg.jpg"),
              baseTexture: require("@/assets/datav-gl-texture.jpg"),
              heightTexture: require("@/assets/datav-gl-texture.jpg"),
